...
Cold start problem (new users/events)
Scraping inconsistency across websites
Assumption: no interaction = no interest
Bias toward frequent event types
Requires continuous retraining for accuracy
Future Improvements
